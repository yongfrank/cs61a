...
class VendingMachine:
    ...
    def vend(self):
        ...
        elif self.fund < self.unit_price:
            return f'Please update your balance with ${10 - self.fund} more funds.'
        elif self.fund > self.unit_price:
            self.fund -= 10
            change_money = self.fund
            self.fund = 0
            self.stock -= 1
            return f'Here is your candy and ${change_money} change.'
        else:
            self.fund = 0
            self.stock -= 1
